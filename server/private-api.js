...
var extendKanjiWithAssets = function (doc){
    ...
    for (var i = 0; i < doc.examples.length; i++){
        ...
        example.opus = 'https://kanjialive.link/examples_audio/audio-opus/' + example.filename + '.opus';
        example.aac = 'https://kanjialive.link/examples_audio/audio-aac/' + example.filename + '.aac';
        example.ogg = 'https://kanjialive.link/examples_audio/audio-ogg/' + example.filename + '.ogg';
        example.mp3 = 'https://kanjialive.link/examples_audio/audio-mp3/' + example.filename + '.mp3';
    ...
    hint = hint.replace(/\[([0-9]+)\]/g, '<img src="https://kanjialive.link/mnemonic_hints/$1.svg" />');
